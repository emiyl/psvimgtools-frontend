...
class Account_Selector:
    def __init__(self, top=None):
        ...
        if backupType_support.getImportType() == "unsign":
            self.Label1.configure(text='''Signed To:''')
        elif backupType_support.getImportType() == "sign":
            self.Label1.configure(text='''Sign To:''')
        elif backupType_support.getImportType() == "resign":
            self.Label1.configure(text='''Signed To:''')
        elif backupType_support.getImportType() == "resign2":
            self.Label1.configure(text='''Re-Sign To:''')
        a=0
        ...
        self.Button1.configure(command = lambda: accSelect_support.chooseAccount(self.accountList.get(ACTIVE)))
