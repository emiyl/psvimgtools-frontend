...
import defs
import sfoParser
import easyinstallers.EmuBubble as EmuBubble
...
def patch(backup):
    import emububble
    emububble.pushVars(backup,account)
    emububble.vp_start_gui(backup,account)
...
class Unsign_Backup:
    def __init__(self, top=None):
        ...
        self.Button1.configure(text='''Patch Backup''')
