...
import fnmatch
import os
from easyinstallers.CmBackup import installCmBackup
...
class Account_Selector:
    def __init__(self, top=None):
        ...
        self.Button1.configure(command = lambda: installCmBackup.cmbackupextract(self.accountList.get(ACTIVE),file=path))
