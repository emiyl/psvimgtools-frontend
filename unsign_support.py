...
try:
    ...
    py3 = 1
##Obtain What Folder Needs To Be Loaded.
...
def browse():
    ...
    if filename.endswith(".psvimg"):
        tkMessageBox.showinfo(title="File Selection", message="File "+filename+" Selected, Please Specifiy An Output "
                                                                               "Directory")
        ...
        tkMessageBox.showinfo(title="File Selection", message="File "+filename+" Selected, Please Specifiy Where To "
...
def goUnsign(cmaBackup,CMA):
    ...
    if load != "SYSTEM":
        ...
        while am != -1:
            if sys.platform.__contains__("linux"):
                print(
                    'Executing: ./psvimg-extract -K ' + cmaKey + ' "' + CMA + "/" + load + "/" + cmaAID + "/" + cmaBackup + "/" +
                    foldParams[am] + "/" + foldParams[am] + '.psvimg" "' + CMA + "/EXTRACTED/" + load + "/" + cmaBackup + "/" +
                    foldParams[am]+'"')
                os.system(
                    './psvimg-extract -K ' + cmaKey + ' "' + CMA + "/" + load + "/" + cmaAID + "/" + cmaBackup + "/" +
                    foldParams[am] + "/" + foldParams[am] + '.psvimg" "' + CMA + "/EXTRACTED/" + load + "/" + cmaBackup + "/" +
                    foldParams[am]+'"')
                print(
                    'Executing: ./psvmd-decrypt -K ' + cmaKey + ' "' + CMA + "/" + load + "/" + cmaAID + "/" + cmaBackup + "/" +foldParams[am] + "/" + foldParams[am] + '.psvmd" "' +CMA + "/EXTRACTED/" + load + "/" + cmaBackup + "/" + foldParams[am]+ '.psvmd-dec"')
                os.system(
                    './psvmd-decrypt -K ' + cmaKey + ' "' + CMA + "/" + load + "/" + cmaAID + "/" + cmaBackup + "/" +foldParams[am] + "/" + foldParams[am] + '.psvmd" "' +CMA + "/EXTRACTED/" + load + "/" + cmaBackup + "/" + foldParams[am]+ '.psvmd-dec"')
                am -= 1
            elif sys.platform.__contains__("win"):
                ...
                os.system(
                    'psvimg-extract.exe -K ' + cmaKey + ' "' + CMA + "/" + load + "/" + cmaAID + "/" + cmaBackup + "/" +
                    foldParams[am] + "/" + foldParams[am] + '.psvimg" "' + CMA + "/EXTRACTED/" + load + "/" + cmaBackup + "/" +
                    foldParams[am]+'"')
                print(
                    'Executing: psvmd-decrypt.exe -K ' + cmaKey + ' "' + CMA + "/" + load + "/" + cmaAID + "/" + cmaBackup + "/" +foldParams[am] + "/" + foldParams[am] + '.psvmd" "' +CMA + "/EXTRACTED/" + load + "/" + cmaBackup + "/" + foldParams[am]+ '.psvmd-dec"')
        ...
        if sys.platform.__contains__("linux"):
            print(
                "Executing: ./psvimg-extract -K " + cmaKey + ' "' + CMA + "/" + load + "/" + cmaAID + "/" + cmaBackup + "/" +cmaBackup+'.psvimg" "' + CMA + "/EXTRACTED/" + load + "/" + cmaBackup+'"')
            os.system("./psvimg-extract -K " + cmaKey + ' "' + CMA + "/" + load + "/" + cmaAID + "/" + cmaBackup + "/" +cmaBackup+'.psvimg" "' + CMA + "/EXTRACTED/" + load + "/" + cmaBackup+'"')
            print(
                "Executing: ./psvmd-decrypt -K " + cmaKey + ' "' + CMA + "/" + load + "/" + cmaAID + "/" + cmaBackup + "/" +cmaBackup+'.psvmd" "' + CMA + "/EXTRACTED/" + load + "/" + cmaBackup +'.psvmd-dec"')
            os.system("./psvmd-decrypt -K " + cmaKey + ' "' + CMA + "/" + load + "/" + cmaAID + "/" + cmaBackup + "/" +cmaBackup+'.psvmd" "' + CMA + "/EXTRACTED/" + load + "/" + cmaBackup +'.psvmd-dec"')
        elif sys.platform.__contains__("win"):
            print(
                "Executing: psvimg-extract.exe -K " + cmaKey + ' "' + CMA + "/" + load + "/" + cmaAID + "/" + cmaBackup + "/" +cmaBackup+'.psvimg" "' + CMA + "/EXTRACTED/" + load + "/" + cmaBackup+'"')
            os.system("psvimg-extract.exe -K " + cmaKey + ' "' + CMA + "/" + load + "/" + cmaAID + "/" + cmaBackup + "/" +cmaBackup+'.psvimg" "' + CMA + "/EXTRACTED/" + load + "/" + cmaBackup+'"')
            print(
                "Executing: psvmd-decrypt.exe -K " + cmaKey + ' "' + CMA + "/" + load + "/" + cmaAID + "/" + cmaBackup + "/" +cmaBackup+'.psvmd" "' + CMA + '/EXTRACTED/' + load + "/" + cmaBackup +'.psvmd-dec"')
