...
class Unsign_Backup:
    def __init__(self, top=None):
        ...
        self.backupList.place(relx=0.03, rely=0.07, relheight=0.85
                , relwidth=0.92)
        ...
        self.Button1.configure(command = lambda: unsign_support.goUnsign(self.backupList.get(ACTIVE), CMA))
        self.Button1.configure(text='''Unsign & Extract''')
        self.Button1.configure(width=117)

        if unsign_support.getResign() == False:
            self.Button2 = Button(top)
            self.Button2.place(relx=0.02, rely=0.93, height=26, width=77)
